...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-Athena_MiSTer.git"
CORE_NAME=(Arcade-Athena)
...
UPSTREAM_CORE_NAME=(Arcade-Athena)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-Athena.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-Athena.rbf)
